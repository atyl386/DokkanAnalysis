...
class State:
    ...
    def branchDamageTaken(
        ...
        pEvadeB = (
            self.multiChanceBuff["EvasionB"].chances["Start of Turn"] + self.multiChanceBuff["EvasionB"].chances["Super Attack Effect"]
...
if __name__ == "__main__":
    unit = Unit(459, "CLR_PHY_UI_Goku_SSGSSE_Vegeta", 5, "ATK", "ADD", "CRT", [1, 1, 3, 3, 3, 3, 3, 3, 3, 3], "True")
