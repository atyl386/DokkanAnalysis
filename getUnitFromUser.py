...
class State:
    ...
    def atk2Dmg(self, atk, pCrit):
        ...
        return (1 - ENEMY_DODGE_CHANCE + ENEMY_DODGE_CHANCE * self.buff["Attacks Guaranteed to Hit"]) * (atk * self.form.unit.critMultiplier * (1 - AVG_ENEMY_DMG_RED) * pCrit + max(atk * self.noCritAtkModifier - MAX_ENEMY_DEF_PER_TURN[self.turn - 1], 0) * (1 - AVG_ENEMY_DMG_RED) * (1 - pCrit))
...
if __name__ == "__main__":
    unit = Unit(321, "DF_PHY_Glorio", 5, "DEF", "ADD", "DGE", SLOT_2)
