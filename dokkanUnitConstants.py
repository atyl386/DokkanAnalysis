...
MEGA_COLOSSAL_SS4_VEGETA_MULTIPLIERS = [0, 0, 5.26, None]
MEGA_COLOSSAL_MULTIPLIERS = [4.1, None, 5.7, 6.2]
ULTIMATE_DAIMA_SS4_GOKU_MULTIPLIERS = [None, None, 8.0, None]
ULTIMATE_SS4_VEGETA_MULTIPLIERS = [None, None, 7.86, None]
...
superAttackMultiplerConversion = [
    ...
    dict(zip(SUPER_ATTACK_LEVELS, MEGA_COLOSSAL_SS4_VEGETA_MULTIPLIERS)),
