...
NUM_ATTACKS_NOT_DIRECTED = NUM_ATTACKS_PER_TURN - NUM_ATTACKS_DIRECTED
PRE_SLOT_1_ATTACK_FRAC = 0.5
NUM_ATTACKS_DIRECTED_BEFORE_ATTACKING = np.array([NUM_ATTACKS_DIRECTED[0] * PRE_SLOT_1_ATTACK_FRAC, 0, 0])
...
NUM_AOE_ATTACKS_BEFORE_ATTACKING = AOE_PROBABILITY_PER_ATTACK * (
    NUM_CUMULATIVE_ATTACKS_BEFORE_ATTACKING - NUM_ATTACKS_DIRECTED_BEFORE_ATTACKING
)
NUM_AOE_ATTACKS = AOE_PROBABILITY_PER_ATTACK * NUM_ATTACKS_NOT_DIRECTED * (1 - PROBABILITY_KILL_ENEMY_AFTER_ATTACKING)
...
NUM_ATTACKS_RECEIVED = (
    NUM_AOE_ATTACKS
    + NUM_ATTACKS_DIRECTED_BEFORE_ATTACKING
    + NUM_ATTACKS_DIRECTED_AFTER_ATTACKING * (1 - PROBABILITY_KILL_ENEMY_BEFORE_RECEIVING_ALL_ATTACKS)
)
...
NUM_SUPER_ATTACKS_DIRECTED = NUM_SUPER_ATTACKS_PER_TURN / NUM_ATTACKS_PER_TURN * NUM_ATTACKS_DIRECTED
NUM_SUPER_ATTACKS_RECEIVED_BEFORE_ATTACKING = np.array([NUM_SUPER_ATTACKS_DIRECTED[0] * PRE_SLOT_1_ATTACK_FRAC, 0, 0])
NUM_SUPER_ATTACKS_DIRECTED_AFTER_ATTACKING = NUM_SUPER_ATTACKS_DIRECTED - NUM_SUPER_ATTACKS_RECEIVED_BEFORE_ATTACKING
NUM_SUPER_ATTACKS_RECEIVED_AFTER_ATTACKING = NUM_SUPER_ATTACKS_DIRECTED_AFTER_ATTACKING * (
    1 - PROBABILITY_KILL_ENEMY_BEFORE_RECEIVING_ALL_ATTACKS
)
NUM_SUPER_ATTACKS_RECEIVED = NUM_SUPER_ATTACKS_RECEIVED_BEFORE_ATTACKING + NUM_SUPER_ATTACKS_RECEIVED_AFTER_ATTACKING
NUM_NORMAL_ATTACKS_RECEIVED_BEFORE_ATTACKING = NUM_ATTACKS_RECEIVED_BEFORE_ATTACKING * FRAC_NORMAL
NUM_NORMAL_ATTACKS_RECEIVED_AFTER_ATTACKING = NUM_ATTACKS_RECEIVED * FRAC_NORMAL - NUM_ATTACKS_DIRECTED_BEFORE_ATTACKING
NUM_NORMAL_ATTACKS_RECEIVED = NUM_NORMAL_ATTACKS_RECEIVED_BEFORE_ATTACKING + NUM_NORMAL_ATTACKS_RECEIVED_AFTER_ATTACKING
