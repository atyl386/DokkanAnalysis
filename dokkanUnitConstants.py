...
NUM_ATTACKS_RECEIVED = (
    ...
    + NUM_ATTACKS_DIRECTED_AFTER_ATTACKING * (1.0 - PROBABILITY_KILL_ENEMY_BEFORE_RECEIVING_ALL_ATTACKS)
)
...
NUM_SUPER_ATTACKS_RECEIVED_BEFORE_ATTACKING = np.array(
    [NUM_SUPER_ATTACKS_DIRECTED[0] * PRE_SLOT_1_ATTACK_FRAC, 0.0, 0.0]
)
...
NUM_SUPER_ATTACKS_RECEIVED_AFTER_ATTACKING = NUM_SUPER_ATTACKS_DIRECTED_AFTER_ATTACKING * (
    1.0 - PROBABILITY_KILL_ENEMY_BEFORE_RECEIVING_ALL_ATTACKS
)
