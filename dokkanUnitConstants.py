...
MAX_T1_NORMAL_DAM = 600000 # SSGSSK Goku (1.5 x on super but can debuff, so assume cancels out)
MAX_NORMAL_DAM = 1000000 # Broly and Cell Max 2
MAX_T1_SA_DAM = 1680000 # SSGSSK Goku (1.5 x on super but can debuff, so assume cancels out)
MAX_SA_DAM = 3000000 # Broly and Cell Max 2
...
EXTRA_BUFF_EFFECTS = ["ATK", "DEF", "Crit", "Ki", "Dmg Red", "Evasion", "aaPSuper", "aaPGuarantee", "Guard", "AEAAT"]
