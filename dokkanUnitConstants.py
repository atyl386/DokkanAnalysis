...
NUM_ATTACKS_DIRECTED = np.array(
    [NUM_ATTACKS_PER_TURN / 2, NUM_ATTACKS_PER_TURN / 4, NUM_ATTACKS_PER_TURN / 4]) # Average number of attacks recieved per turn. 3 elements correspons to slot 1, 2 and 3.
...
NUM_ATTACKS_DIRECTED_BEFORE_ATTACKING = np.array([NUM_ATTACKS_DIRECTED[0] * PRE_SLOT_1_ATTACK_FRAC, 0.0, 0.0])
...
NUM_ATTACKS_RECEIVED = NUM_AOE_ATTACKS + NUM_ATTACKS_DIRECTED_BEFORE_ATTACKING + NUM_ATTACKS_DIRECTED_AFTER_ATTACKING * (
    1.0
...
NUM_SUPER_ATTACKS_RECEIVED_BEFORE_ATTACKING = np.array([NUM_SUPER_ATTACKS_DIRECTED[0] * PRE_SLOT_1_ATTACK_FRAC, 0.0, 0.0])
...
SUPER_ATTACK_EFFECTS = ["ATK", "DEF", "Critical Hit", "Disable Action"]
