...
NUM_AOE_ATTACKS = AOE_PROBABILITY_PER_ATTACK * NUM_ATTACKS_NOT_SLOT_SPECIFIC * (1 - PROBABILITY_KILL_ENEMY_AFTER_ATTACKING)
...
NUM_SUPER_ATTACKS_DIRECTED_BEFORE_ATTACKING = np.array([NUM_SUPER_ATTACKS_SLOT_SPECIFIC[0] * PRE_SLOT_1_ATTACK_FRAC, 0, 0])
NUM_SUPER_ATTACKS_SLOT_SPECIFIC_AFTER_ATTACKING = NUM_SUPER_ATTACKS_SLOT_SPECIFIC - NUM_SUPER_ATTACKS_DIRECTED_BEFORE_ATTACKING
...
NUM_NORMAL_ATTACKS_DIRECTED_AFTER_ATTACKING = NUM_ATTACKS_DIRECTED * FRAC_NORMAL - NUM_ATTACKS_SLOT_SPECIFIC_BEFORE_ATTACKING
