...
SUPER_ATTACK_MULTIPLIER_NAMES = [
    ...
    "Immense",
    "Colossal",
    "Mega-Colossal DAIMA SS4 Goku",
    "Mega-Colossal",
    "Ultimate DAIMA SS4 Goku",
    "Ultimate SS4 Vegeta",
    "Ultimate UI Goku",
    "Ultimate",
]
...
MEGA_COLOSSAL_DAIMA_SS4_GOKU_MULTIPLIERS = [0, 0, 5.3, None]
MEGA_COLOSSAL_MULTIPLIERS = [4.1, None, 5.7, 6.2]
ULTIMATE_DAIMA_SS4_GOKU_MULTIPLIERS = [None, None, 8.4, None]
ULTIMATE_SS4_VEGETA_MULTIPLIERS = [None, None, 8.3, None]
ULTIMATE_UI_GOKU_MULTIPLIERS = [None, None, 8.7, None]
ULTIMATE_MULTIPLIERS = [5.29, None, None, None]
...
MIN_EVALUATION = -3 # Corresponds to unit being just useable when rainbowed
ATTTRIBUTE_NAMES = [
    "Leader Skill",
    "SBR",
    "HP",
...
# Teams
NUM_CATEGORIES_PER_UNIT_MAX = 26 # DFLR_STR_SSGSS_Goku_Vegeta has 26 categories
NUM_CATEGORIES = 95
...
AOE_PROBABILITY_PER_ATTACK = 0.05  # Complete guess
...
MAX_ENEMY_DMG_THRESHOLD = 11000000 # Jiren Tours
...
ATK_DEF = ["ATK", "DEF"]
STACK_EFFECTS = ["ATK", "DEF", "Crit", "Evasion"]
...
AEAAT_SUPPORT_100_FACTOR = AEAAT_MULTIPLIER / AVG_TYPE_ADVANATGE * ATK_SUPPORT_100_FACTOR
...
EVASION_CHANCES = ["HiPo", "Start of Turn", "Links", "Active Skill", "Super Attack Effect"]
...
superAttackMultiplerConversion = [
    ...
    dict(zip(SUPER_ATTACK_LEVELS, MEGA_COLOSSAL_DAIMA_SS4_GOKU_MULTIPLIERS)),
    dict(zip(SUPER_ATTACK_LEVELS, MEGA_COLOSSAL_MULTIPLIERS)),
    dict(zip(SUPER_ATTACK_LEVELS, ULTIMATE_DAIMA_SS4_GOKU_MULTIPLIERS)),
    dict(zip(SUPER_ATTACK_LEVELS, ULTIMATE_SS4_VEGETA_MULTIPLIERS)),
    dict(zip(SUPER_ATTACK_LEVELS, ULTIMATE_UI_GOKU_MULTIPLIERS)),
...
HIPO_SPECIAL_EQUIPS = {
    ...
    # STR Gamma 1 (sub-optimal)
    "134" : {
        "BRZ": [0, 800, 0, 0, 0],
        "SLV": [0, 400, 0.08, 0, 0],
        "GLD": [0, 0, 0.10, 0.06, 0]
    },
    # INT Kid Pan (sub-optimal)
    "139" : {
        "BRZ": [0, 800, 0, 0, 0],
        "SLV": [0, 400, 0.08, 0, 0],
        "GLD": [0, 0, 0.10, 0.06, 0]
    },
    # AGL Gamma 2 (sub-optimal)
    "150" : {
        "BRZ": [0, 800, 0, 0, 0],
        "SLV": [0, 400, 0.08, 0, 0],
        "GLD": [0, 0, 0.10, 0.06, 0]
    },
    # INT SS Goten (sub-optimal)
    "168" : {
        "BRZ": [0, 800, 0, 0, 0],
        "SLV": [0, 400, 0.08, 0, 0],
        "GLD": [0, 0, 0.10, 0.06, 0]
    },
    # TEQ SS Trunks (sub-optimal)
    "169" : {
        "BRZ": [0, 800, 0, 0, 0],
        "SLV": [0, 400, 0.08, 0, 0],
        "GLD": [0, 0, 0.10, 0.06, 0]
    ...
    # DFLR TEQ Super Vegito
    "327" : {
        "BRZ": [0, 900, 0, 0, 0],
        "SLV": [0, 1200, 0, 0, 0.06],
        "GLD": [0, 0, 0.12, 0.12, 0]
    },
    # DF INT Super Janemba
    "328" : {
        "BRZ": [0, 900, 0, 0, 0],
        "SLV": [0, 1200, 0, 0, 0.06],
        "GLD": [0, 0, 0.12, 0.12, 0]
    ...
    # DFLR AGL Full Power Frieza
    "330" : {
        "BRZ": [800, 0, 0, 0, 0],
        "SLV": [0, 800, 0.04, 0, 0],
        "GLD": [0, 1200, 0.08, 0, 0]
    },
    # DFLR INT SS Namek Goku
    "331" : {
        "BRZ": [800, 0, 0, 0, 0],
        "SLV": [0, 800, 0.04, 0, 0],
        "GLD": [0, 1200, 0.08, 0, 0]
    ...
    # F2P AGL Goku Black Clone
    "377" : {
        "BRZ": [0, 900, 0, 0, 0],
        "SLV": [0, 600, 0, 0, 0.05],
        "GLD": [0, 900, 0, 0, 0.06]
    },
    # F2P TEQ Goku Black Clone
    "378" : {
        "BRZ": [0, 900, 0, 0, 0],
        "SLV": [0, 600, 0, 0, 0.05],
        "GLD": [0, 900, 0, 0, 0.06]
    },
    # F2P INT Goku Black Clone
    "379" : {
        "BRZ": [0, 900, 0, 0, 0],
        "SLV": [0, 600, 0, 0, 0.05],
        "GLD": [0, 900, 0, 0, 0.06]
    },
    # F2P STR Goku Black Clone
    "380" : {
        "BRZ": [0, 900, 0, 0, 0],
        "SLV": [0, 600, 0, 0, 0.05],
        "GLD": [0, 900, 0, 0, 0.06]
    },
    # F2P PHY Goku Black Clone
    "381" : {
        "BRZ": [0, 900, 0, 0, 0],
        "SLV": [0, 600, 0, 0, 0.05],
        "GLD": [0, 900, 0, 0, 0.06]
    ...
    # DF AGL SSR Goku Black
    "383" : {
        "BRZ": [0, 800, 0, 0, 0],
        "SLV": [0, 400, 0, 0, 0.04],
        "GLD": [0, 0, 0, 0.04, 0.05],
    },
    # F2PLR STR Nuova Shenron
    "384" : {
        "BRZ": [0, 900, 0, 0, 0],
        "SLV": [0, 600, 0, 0, 0.05],
        "GLD": [0, 900, 0, 0, 0.06],
    },
    # DFLR PHY Omega Shenron
    "386" : {
        "BRZ": [0, 900, 0, 0, 0],
        "SLV": [0, 1200, 0, 0, 0.06],
        "GLD": [0, 0, 0.12, 0.12, 0]
    ...
    # BU TEQ Manga SS2 Gohan
    "432" : {
        "BRZ": [0, 900, 0, 0, 0],
        "SLV": [0, 600, 0.1, 0, 0],
        "GLD": [0, 1200, 0.12, 0, 0],
    },
    # BU INT Manga Final Form Frieza
    "433" : {
        "BRZ": [900, 0, 0, 0, 0],
        "SLV": [0, 0, 0, 0, 0.06],
        "GLD": [1500, 1500, 0, 0, 0],
    },
    # BU AGL Manga Majin Buu
    "434" : {
        "BRZ": [0, 900, 0, 0, 0],
        "SLV": [0, 600, 0, 0, 0.05],
        "GLD": [0, 1200, 0, 0, 0.06],
    ...
    # DF AGL Gohan Gamma 1
    "444" : {
        "BRZ": [0, 800, 0, 0, 0],
        "SLV": [0, 400, 0, 0, 0.04],
        "GLD": [0, 0, 0.1, 0, 0.02],
    },
    # DF STR Gamma 2 Piccolo
    "445" : {
        "BRZ": [0, 800, 0, 0, 0],
        "SLV": [0, 400, 0.04, 0, 0],
        "GLD": [0, 0, 0.1, 0.02, 0],
...
FIXED_SLOT_UNITS = {
    ...
    461: "BU STR Yakon", # Slot 3 only after turn 3 to get evasion buff
}