...
MEGA_COLOSSAL_US_NO_EX_SUPER_MULTIPLIERS = [0, 0, 5.3, None]
...
superAttackMultiplerConversion = [
    ...
    dict(zip(SUPER_ATTACK_LEVELS, MEGA_COLOSSAL_US_NO_EX_SUPER_MULTIPLIERS)),
