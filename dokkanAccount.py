...
User = [['A','C','D',1], # TEQLR SS Goku
    ...
    ['C','A','D',3], # STR Kid Buu
    ['D','A','D',4], # PHY Super Saiyan 2 Goku
    ['A','D','D',0],  # RoF Blues
    ...
    ['A','D','D',1], # INT LSS Broly
    ['D','A','D',2], # AGL Paikuhan
    ['D','A','D',1], # TEQ Janemba
    ['D','A','D',2], # STR UI Goku
    ['A','D','D',3], # TEQ VB
