...
print(Rotation) """
WWDL_1 = Banner([36, 19, 31, 30, 17, 150, 39, 34, 8, 33, 40, 140, 11, 163, 21, 21, 41, 170, 93, 163, 135, 127, 126, 86, 104, 142, 142, 60, 60, 128, 128, 128, 55, 127, 10, 188, 188, 183, 183, 116, 25, 116, 116, 25, 116, 170, 170, 211, 25, 170, 116, 25, 25, 25, 101, 170],'red', discount=50*(2 + 10 * 2)/100)
print(WWDL_1.summonScore)
WWDL_2 = Banner([25, 18, 5, 7, 32, 134, 45, 38, 46, 25, 10, 20, 9, 25, 163, 48, 48, 25, 164, 155, 98, 163, 146, 131, 25, 145, 129, 25, 54, 8, 25, 132, 116, 25, 146, 48, 8, 126, 8, 25, 146, 25, 25, 48, 163, 41, 25, 48, 48, 25, 156, 25, 25, 25, 170, 170],'red', discount=50*(2 + 10 * 2)/100)
