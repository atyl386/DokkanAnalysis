...
print(Rotation) """
BlackFridayFestival = Banner([81, 66, 102, 57, 110, 15, 164, 86, 60, 54], 'red', threePlus1=True)
print(BlackFridayFestival.summonScore)
BlackFridayCarnival = Banner([67, 83, 12, 13, 214, 222, 217, 252, 89, 87], 'cyan', threePlus1=True)
