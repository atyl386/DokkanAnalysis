...
GoldenBois = Banner([105,107,7,8,38,3,24,14,38,83],'red',threePlus1=True,tickets=True)
print(GoldenBois.summonScore)
# New LR, eis&nouza, goku&vegeta, gamma2, ss goku, lr ss4s, ui goku, teq vegiot, phy buutenks, ss goku
GTBois = Banner([106,108,6,9,83,2,38,24,38,83],'red',threePlus1=True,tickets=True)
